...
CREDIT_LEVEL_FEED = {0: ['呐，{name}你问这个是想做什么呀？',
                     ...
                     CHAT_CREDIT_LV5: [('{name}, 当我们回首往事, 我们可能不会记得当时说了些什么, 或许不会记得任何细节,'
                                        ' 但我们都会记得, 我在那里和你们一起 ———— 而这才是最重要的。'),
                                       '{name}, 能与你相遇, 真是太好了',
...
NAME2TITLE = {'梨子': '伊丽莎白最喜欢的水果',
              '群青公主': ('群青公主 Ultramarine Princess是伊丽莎白信仰的神明哦~ 祂的真名是阿弗洛狄忒 Aphrodite, '
                       '祂是深海之主，厄运之神，美丽与欲望的化身，梦境与幻象的主宰.'),
              '阿弗洛狄忒': ('阿弗洛狄忒 Aphrodite被我们人鱼一族尊称为群青公主 Ultramarine Princess, '
                        '祂的神职是海洋 Ocean; 灾厄 Adversity; 繁殖 Breed; 梦境 Dream; 幻象 Illusion.'),
              '群青公主阿弗洛狄忒': ('群青公主 Ultramarine Princess 阿弗洛狄忒 Aphrodite '
                            '是深海之主，厄运之神，美丽与欲望的化身，梦境与幻象的主宰. '
                            '阿弗洛狄忒的教会分成数个教派，不同教派的理念相差很大，主要包括由我们人鱼领导的克制派与邪恶鱼人和海怪组成的放纵派。'),
              '伊丽莎白': '一条小人鱼',
