...
HELP_STR += '伊丽莎白说明手册: https://docs.qq.com/doc/DV1ZueVVmZkV2dWpI\n'
...
SHOW_STR += '伊丽莎白是D&D5E专用骰娘, 熟练掌握的技能包括: 优劣势投骰, 查询资料, 记录角色卡(生命值, 属性, 法术环位, 金钱), 实用先攻列表等\n'
...
HELP_COMMAND_UPDATE_STR = '2020/12/6 v0.8.0: 1.增加了关于神祇和恶魔领主的查询资料 2.执行.bot off后不会回应彩蛋了 3.执行中遇到错误会将其发送给骰主\n'
HELP_COMMAND_UPDATE_STR += '2020/11/17 v0.7.1: 1.增加了群管理功能, 包括启用/禁用特定功能, 统计群成员信息, 请输入.help群管理查看\n'
HELP_COMMAND_UPDATE_STR += '2020/11/6 v0.7.0: 1.增加搭建说明 2.修复了更新时无法正确处理过期用户的问题\n'
HELP_COMMAND_UPDATE_STR += '2020/11/1 v0.6.4: 1.更改了好感度设定 2.修复了若干文本问题\n'
HELP_COMMAND_UPDATE_STR += '2020/5/5 v0.6.3: 1.加入了答题功能 2.增加了更多的随机姓名 3.增加了更多的今日笑话\n'
HELP_COMMAND_UPDATE_STR += '2020/4/26 v0.6.2: 1.实验性地于查询指令中加入了交互命令, 具体使用方法请输入.help交互 或 .help查询 查看\n'
...
HELP_COMMAND_STR += '.ri/.init 投掷先攻和先攻列表\n'
...
HELP_COMMAND_STR += '.烹饪/.点菜/.今日菜单 烹饪检定/模拟点菜/随机菜单\n'
HELP_COMMAND_STR += '.今日笑话 获取一个随机TRPG冷笑话吧~\n'
HELP_COMMAND_STR += '.dnd/.name 随机属性/姓名\n'
HELP_COMMAND_STR += '.jrrp 今日人品\n'
HELP_COMMAND_STR += '.send 向骰主发送消息\n'
...
HELP_COMMAND_R_STR =  '掷骰：.r[掷骰表达式]([掷骰原因])\n'
HELP_COMMAND_R_STR += '[掷骰表达式]：([轮数]#)[个数]d面数(优/劣势)(k[取点数最大的骰子数])不带面数时视为掷一个默认的20面骰\n'
