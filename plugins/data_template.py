...
userInfoTemp = {'name':'', 'credit':0, 'activeDate':GetCurrentDateStr(), 'spamAccu':0, 'commandAccu':0, 'messageAccu':0, 'dndCommandAccu':0, 'commandDaily':0, 'messageDaily': 0, 'dndCommandDaily':0 ,
...
groupInfoTemp = {'name':'未知群名称' , 'inviter':'', 'activeDate':GetCurrentDateStr(), 'days':0 ,'chatDate':GetCurrentDateStr(), 'active':True, 'credit':0,
                 ...
                 'welcome':'欢迎新人~', 'warning':0, 'noticeBool':True, 'noticeStr':FIRST_TIME_STR, 'note':{}, 'BanFunc':{}}
